...
1. To change the [namespace](xref:ccNamespaces), click the **Change Namespace** button ![Namespace button](images/namespace-btn.png), then select the namespace and click **Continue**.
